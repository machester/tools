...
BOOL CDlgSettings::OnInitDialog()
{
	...
	m_TabItem.InsertItem(5,GetLocalString(_T("CUST1")).c_str());
	// m_TabItem.InsertItem(6,GetLocalString(_T("CUST2")).c_str());
...
std::wstring CDlgSettings::GetLocalString(std::wstring strKey)
{
